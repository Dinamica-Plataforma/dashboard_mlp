...
import CharacterizationMap from "./Map";
import config_json from "./InfoTable.json";

export default function CaracterizacionMap() {
  return (
      <main className="h-screen bg-gradient-to-br from-[#eaf6f7] via-white to-[#186170]/10 grid grid-rows-[auto_1fr]">
        ...
        <div>
        <CharacterizationMap style={{ height: '100%', width: '100%' }} kmlUrl={'/kmz/caract.kml'} config={config_json} />
        </div>
      </main>
  );
}
